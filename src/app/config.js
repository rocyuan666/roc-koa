...
module.exports = { APP_HOST, APP_PORT, HTTPORHTTPS, APP_UPLOAD_BASEURL, MYSQL_HOST, MYSQL_PORT, MYSQL_DATABASE, MYSQL_USER, MYSQL_PASSWORD, REDIS_HOST, REDIS_PORT } = process.env;
